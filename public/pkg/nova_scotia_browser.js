...
* @returns {string}
*/
module.exports.verify_compressed_proof = function(pp_str, proof_str, start_json_str) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        wasm.verify_compressed_proof(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
...
const path = require('path').join(__dirname, 'nova_scotia_browser_bg.wasm');
